                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="btn-group float-left">
                                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Reporting</h3>
                                </div>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" name="type[]" value="'april'" id="customCheck4">
                                ...
                                <div class="table-responsive">
                                    <table style="font-size: 14px;" id="myTable" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <thead>
                                                ...
                                                <th class="text-center">Masa review</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['simpan'])) {
                                                ...
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE " . $and);
                                            } elseif (isset($_GET['jan'])) {
                                                $jan = $_GET['jan'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$jan%' AND is_approved = 0");
                                            } elseif (isset($_GET['feb'])) {
                                                $feb = $_GET['feb'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$feb%' AND is_approved = 0");
                                            } elseif (isset($_GET['mar'])) {
                                                $mar = $_GET['mar'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$mar%' AND is_approved = 0");
                                            } elseif (isset($_GET['apr'])) {
                                                $apr = $_GET['apr'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$apr%' AND is_approved = 0");
                                            } elseif (isset($_GET['may'])) {
                                                $may = $_GET['may'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$may%' AND is_approved = 0");
                                            } elseif (isset($_GET['jun'])) {
                                                $jun = $_GET['jun'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$jun%' AND is_approved = 0");
                                            } elseif (isset($_GET['jul'])) {
                                                $jul = $_GET['jul'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$jul%' AND is_approved = 0");
                                            } elseif (isset($_GET['aug'])) {
                                                $aug = $_GET['aug'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$aug%' AND is_approved = 0");
                                            } elseif (isset($_GET['sep'])) {
                                                $sep = $_GET['sep'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$sep%' AND is_approved = 0");
                                            } elseif (isset($_GET['oct'])) {
                                                $oct = $_GET['oct'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$oct%' AND is_approved = 0");
                                            } elseif (isset($_GET['nov'])) {
                                                $nov = $_GET['nov'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$nov%' AND is_approved = 0");
                                            } elseif (isset($_GET['des'])) {
                                                $des = $_GET['des'];
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE tanggal_perjanjian LIKE '%$des%' AND is_approved = 0");


                                            } elseif (isset($_GET['januari'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'januari' AND is_approved = 0");
                                            } elseif (isset($_GET['februari'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'februari' AND is_approved = 0");
                                            } elseif (isset($_GET['maret'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'maret' AND is_approved = 0");
                                            } elseif (isset($_GET['april'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'april' AND is_approved = 0");
                                            } elseif (isset($_GET['mei'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'mei' AND is_approved = 0");
                                            } elseif (isset($_GET['juni'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'juni' AND is_approved = 0");
                                            } elseif (isset($_GET['juli'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'juli' AND is_approved = 0");
                                            } elseif (isset($_GET['agustus'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'agustus' AND is_approved = 0");
                                            } elseif (isset($_GET['september'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'september' AND is_approved = 0");
                                            } elseif (isset($_GET['oktober'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'oktober' AND is_approved = 0");
                                            } elseif (isset($_GET['november'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'november' AND is_approved = 0");
                                            } elseif (isset($_GET['desember'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE jenis_perjanjian = 'desember' AND is_approved = 0");

                                            } elseif (isset($_GET['2023'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2023' AND is_approved = 0");
                                            } elseif (isset($_GET['2024'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2024' AND is_approved = 0");
                                            } elseif (isset($_GET['2025'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2025' AND is_approved = 0");
                                            } elseif (isset($_GET['2026'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2026' AND is_approved = 0");
                                            } elseif (isset($_GET['2027'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2027' AND is_approved = 0");
                                            } elseif (isset($_GET['2028'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2028' AND is_approved = 0");
                                            } elseif (isset($_GET['2029'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2029' AND is_approved = 0");
                                            } elseif (isset($_GET['2030'])) {
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE `year` = '2030' AND is_approved = 0");
                                                ...
                                                $sql = mysqli_query($conn, "SELECT * FROM docss WHERE is_approved = 0");
                                            }
                                            $no=1;
                                            $n = 1;
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo "$no";$no++; ?></td>
                                                    <td style="width:200px;"><a href="docdownload.php?id_dokumen=<?= $data[0] ?>"><?= $data[1]; ?></a></td>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($data["status1"] == 0) {
                                                            echo "<i class='fas fa-circle text-success '></i>Close";
