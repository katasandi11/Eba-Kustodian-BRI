    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $sql = mysqli_query($conn, "SELECT * FROM reporting_docss WHERE id_dokumen = '$id_dokumen'");
                $sql2 = mysqli_query($conn, "SELECT * FROM activities_reporting WHERE id_dokumen = '$id_dokumen' ORDER BY created_at DESC LIMIT 4 ");
                $sql2y = mysqli_query($conn, "SELECT * FROM activities_reporting WHERE id_dokumen = '$id_dokumen' ORDER BY created_at DESC");
                $sql3 = mysqli_query($conn, "SELECT comments_reporting.id_comment, comments_reporting.id_user, comments_reporting.comment, comments_reporting.created_at, users.name, users.role FROM comments_reporting inner join users on comments_reporting.id_user=users.id WHERE id_dokumen = '$id_dokumen'");
...
<a download href="docss/<?= $doc[2]; ?>" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-download"></i> Download</a>
                <?php
                if ($_SESSION['role'] == 'Maker' && $doc[12] != 0) {
                ?>
                    <a href="1reportingedit.php?id=<?= $doc[0] ?>" class="float-right btn btn-warning btn-rounded waves-effect waves-light px-3">
                ...
                ?>
                    <div class="float-right">
                        <a href="functions/Approver1.php?approve=<?= $doc[0] ?>" data-toggle="tooltip" title="Approve" class="btn btn-success">
                            <i class="fas fa-check"></i>
                        </a>
                        <a href="functions/Approver1.php?reject=<?= $doc[0] ?>" data-toggle="tooltip" title="Reject" class="btn btn-warning">
                            <i class="fas fa-times"></i>
                        </a>
                        <a href="functions/Approver1.php?cancel=<?= $doc[0] ?>" data-toggle="tooltip" title="Cancel" class="btn btn-danger">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- <a href="">Download</a> -->
                                        <!-- <hr class="mt-4"> -->
                                        <iframe src="docss/<?= $doc[2]; ?>" type="application/pdf" height="800px" width="100%"></iframe>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                <a href="functions/comment1.php?id_comment=<?= $comment['id_comment'] ?>&id_dokumen=<?= $doc[0] ?>" class="text-danger h3">
                                        ...
                                        ?>
                                            <form class="mt-3" action="functions/comment1.php" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr class="mt-4">
                                        <p>Description : <?= $doc[1]; ?></p>
                                        <p>Media Pelaporan : <?= $doc[3]; ?></p>
                                        <p>Month : <?= $doc[4]; ?></p>
                                        <p>To : <?= $doc[5]; ?></p>
                                        <p>Due Date : <?= $doc[6]; ?></p>
                                        <p>Year : <?= $doc["year"]; ?></p>
