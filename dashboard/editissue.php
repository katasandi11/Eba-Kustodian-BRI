                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <?php
                                $id = $_GET["id"];
                                $data = mysqli_query($conn, "SELECT * FROM complaint_isue WHERE id = '$id'");
                                $row = mysqli_fetch_row($data);
                                ?>
                                <h4 class="card-title">Update Issue</h4>
                                <hr>
                                <form action="functions/updateissue.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>Status Issue <span class="text-danger">*</span></label>
