                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="btn-group float-left">
                                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">List Reporting</h3>
                                </div>
                                    ...
                                    <thead>
                                        ...
                                        <?php
                                            if (isset($_POST['simpan'])) {
                                                ...
                                                $sql = mysqli_query($conn, "SELECT * FROM reporting_docss WHERE is_approved = 1 AND status1 = 1");
                                            }
                                            $no=1;
                                            $n = 1;
                                                  ...
                                                  <tr>
                                                    ...
                                                    <!-- <td style="white-space: nowrap;">
                                                       ...
                                                       <td>
                                                        <?php
                                                        if ($data["status1"] == 0) {
                                                            echo "<i class='fas fa-spinner-border text-success '></i> Close";
                                                        } elseif ($data["status1"] == 1) {
                                                            echo "<i class='fas spinner-border spinner-border-sm text-danger'></i>  Open";
                                                        } else {
                                                            echo "<i class='fas fa-spinner text-warning '></i>  Open";
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>
