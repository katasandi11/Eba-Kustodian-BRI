                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="btn-group float-left">
                                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">List Issue</h3>
                                </div>
                                ...
                                if(isset($_GET['filter'])){
                                    ...
                                    $sql = mysqli_query($conn, "SELECT * FROM complaint_isue WHERE `dateawal`  BETWEEN  '$tglawal' and '$tglakhir' ");
                                    
                                }else{
                                 $sql = mysqli_query($conn, "SELECT * FROM complaint_isue WHERE `dateawal` ");
                                }
                                }else{
                                 $sql = mysqli_query($conn, "SELECT * FROM complaint_isue WHERE `dateawal` ");
                                }
