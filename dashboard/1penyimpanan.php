                                    ...
                                    <table width="1600" style="color:#333;font-size: 14px;" id="myTable" class="table table-striped table-bordered">
                                        ...
                                        <?php
                                            if (isset($_POST['simpan'])) {
                                                ...
                                                $sql = mysqli_query($conn, "SELECT * FROM reporting_docss WHERE is_approved = 1");
                                            }
                                            $no=1;
                                            $n = 1;
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td style="white-space: nowrap;">
                                                        ...
                                                        if ($data[10] == 'Masa Review') {
                                                            echo "$days_remaining hari dan $hours_remaining jam lagi <i class='fas fa-circle text-warning '></i><br>";
                                                        } else {
                                                            echo "Done <i class='fas fa-circle text-success'></i>";
                                                        }
                                                        ?>
                                                    </td>
