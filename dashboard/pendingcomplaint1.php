                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if(isset($_GET['filter'])){
                                    ...
                                    $sql = mysqli_query($conn, "SELECT * FROM complaint WHERE `dateawal`  BETWEEN  '$tglawal' and '$tglakhir' and`status` <> 1");
                                    
                                }else{
                                 $sql = mysqli_query($conn, "SELECT * FROM complaint WHERE `dateawal` and`status` <> 1 ");
                                }
                                }else{
                                 $sql = mysqli_query($conn, "SELECT * FROM complaint WHERE `dateawal` and`status` <> 1 ");
                                }
