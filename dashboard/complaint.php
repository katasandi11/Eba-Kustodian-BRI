...
<head>
    ...
    <title>Complaint Handling</title>
</head>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title d-inline">Input complaint</h4>
                               
                                <hr>
                                
<form action="functions/complain.php" method="POST" enctype="multipart/form-data">                                
                    ...
                    <label for="date">Date Of Complaint <span class="text-danger">*</span></label><br>
                    <input type="date" id="date" name="dateawal" required><br>
                    
                    <input type="hidden" id="date" name="dateakhir" required><br>
                    <label for="title">Complaint Title <span class="text-danger">*</span></label><br>
                    ...
                    <input type="hidden" id="solution" name="solution" required></input>
                    
                    
                 
                                            
                    <label class="mr-sm-2" for="inlineFormCustomSelect">Assign To <span class="text-danger">*</span></label><br>
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="notif" required>
                                                    <option disabled selected value>Choose..</option>
                                                     <?php 
                                                    $users = mysqli_query($conn, "SELECT * FROM users WHERE notif = 'notif'"); 
