                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="btn-group float-left">
                                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Pending Complaint</h3>
                                </div>
                                ...
                                <div class="btn-group float-right">
                                    ...
                                    <!-- <a href="?" class="btn btn-outline-secondary"><i class="fas fa-undo"></i> Reset</a> -->
                                        ...
                                        <a href="complaint.php" class="ml-2 btn btn-primary">+ Add</a>
                                ...
                                if(isset($_GET['filter'])){
                                    ...
                                    $sql = mysqli_query($conn, "SELECT * FROM complaint WHERE `dateawal`  BETWEEN  '$tglawal' and '$tglakhir' and`status` <> 1 AND notif = '$_SESSION[id]'");
                                    
                               
                                }else{
                                 $sql = mysqli_query($conn, "SELECT * FROM complaint WHERE `dateawal` and`status` <> 1 AND notif = '$_SESSION[id]' ");
                                }
                                }else{
                                 $sql = mysqli_query($conn, "SELECT * FROM complaint WHERE `dateawal` and`status` <> 1 AND notif = '$_SESSION[id]' ");
                                }
                                ...
                                $no=1;
                                     ...
                                     ?>
                                         ...
                                         <td style="width:200px;"><a href="updatecomplaint.php?id=<?= $data[0] ?>"><?= $data["nama"]; ?></a></td>
                                         <td><?= $data["contact"]; ?></td>
