                            ...
                            <div class="card-body">
                                ...
                                <form action="functions/upload2.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="nama_dokumen" required>
                                                    <option disabled selected value>Choose...</option>
                                                    <option value="Laporan Kantor Pusat Bank Umum (LKPBU)">Laporan Kantor Pusat Bank Umum (LKPBU)</option>
                                                    <option value="Laporan Aktivitas Reksadana ">Laporan Aktivitas Reksadana</option> <!-- KPD (Kontrak Pengelolaan Dana) -->
                                                    <option value="Laporan Aktifitas Kustodian dan Asset Under Custody ">Laporan Aktifitas Kustodian dan Asset Under Custody</option> <!-- Reksadana -->
                                                    <option value="Laporan Dana Jaminan Asuransi Konvensional & Syariah">Laporan Dana Jaminan Asuransi Konvensional & Syariah</option> <!-- EBA (Efek Beragun Aset) -->
                                                    <option value=" Pelaporan SI-BISSSS : SI BI-SSSS">Pelaporan SI-BISSSS : SI BI-SSSSi</option> <!-- Ops Memo -->
                                                    <option value="Laporan kepada KAP untuk audit tahunan">Laporan kepada KAP untuk audit tahunan</option> <!-- Selling Agent -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="nasabah" required>
                                                    <option disabled selected value>Choose...</option>
                                                    <option value="Apolo BUK">Apolo BUK</option>
                                                    <option value="Apolo Pasar Modal & Sipena">Apolo Pasar Modal & Sipena</option> <!-- KPD (Kontrak Pengelolaan Dana) -->
                                                    
                                                    <option value="Manual / Email & Fisik">Manual / Email & Fisik</option> <!-- EBA (Efek Beragun Aset) -->
                                                    <option value="harian & bulanan">harian & bulanan</option> <!-- Ops Memo -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="nomor_perjanjian" required>
                                                    <option disabled selected value>Choose...</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="nomor_perjanjian_terkait" required>
                                                    <option disabled selected value>Choose...</option>
                                                    <option value="5 hari kerja">5 hari kerja</option>
                                                    <option value="10 hr kerja">10 hr kerja</option> <!-- KPD (Kontrak Pengelolaan Dana) -->
                                                    <option value="15 hr kerja ">15 hr kerja</option> <!-- Reksadana -->
                                                    <option value="3 hr kerja">3 hr kerja</option> <!-- EBA (Efek Beragun Aset) -->
                                                    <option value="tanggal 31 maret tahun berikutnya">tanggal 31 maret tahun berikutnya</option> <!-- Ops Memo -->
